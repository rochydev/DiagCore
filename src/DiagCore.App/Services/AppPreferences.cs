...
{
    /// <summary>
    /// Version string for which the welcome window has already been
    /// acknowledged. Null/empty means it has never been shown.
    /// </summary>
    public string? LastWelcomeVersionShown { get; set; }
